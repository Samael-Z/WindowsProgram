...
BEGIN_MESSAGE_MAP(CRegeditApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CRegeditApp::OnAppAbout)
	// 基于文件的标准文档命令
...
CRegeditApp::CRegeditApp() noexcept
{
	// 支持重新启动管理器
	...
	SetAppID(_T("Regedit.AppID.NoVersion"));
