...
// RegeditDoc.cpp: CRegeditDoc 类的实现
//
...
CRegeditDoc::CRegeditDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CRegeditDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CRegeditDoc::InitializeSearchContent()
{
...
void CRegeditDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
